...
// GetBillCreditNoteSourceModifiedDateLineItemsAccountRef - Reference to the account to which the line item is linked.
...
// GetBillCreditNoteSourceModifiedDateLineItemsItemRef - Reference to the item the line is linked to.
type GetBillCreditNoteSourceModifiedDateLineItemsItemRef struct {
	ID   string  `json:"id"`
	Name *string `json:"name,omitempty"`
}

// GetBillCreditNoteSourceModifiedDateLineItemsTaxRateRef - Reference to the tax rate to which the line item is linked.
...
// GetBillCreditNoteSourceModifiedDateLineItemsTrackingCategoryRefs - References a category against which the item is tracked.
...
// GetBillCreditNoteSourceModifiedDateLineItemsTracking - Categories, and a project and customer, against which the item is tracked.
...
// GetBillCreditNoteSourceModifiedDatePaymentAllocationsPaymentAccountRef - The account that the allocated payment is made from or to.
...
// GetBillCreditNoteSourceModifiedDateStatusEnum - Current state of the bill credit note
...
// GetBillCreditNoteSourceModifiedDateSupplierRef - Supplier that issued the bill credit note.
...
// GetBillCreditNoteSourceModifiedDate - > **Bill credit notes or credit notes?**
// >
