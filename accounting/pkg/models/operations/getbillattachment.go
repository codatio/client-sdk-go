...
type GetBillAttachmentAttachmentModifiedDate struct {
	// The date on which this record was last modified in Codat.
	ModifiedDate *string `json:"modifiedDate,omitempty"`
}

type GetBillAttachmentAttachmentSourceModifiedDate struct {
...
type GetBillAttachmentAttachment struct {
	...
	ModifiedDate       *GetBillAttachmentAttachmentModifiedDate       `json:"modifiedDate,omitempty"`
	Name               *string                                        `json:"name,omitempty"`
	SourceModifiedDate *GetBillAttachmentAttachmentSourceModifiedDate `json:"sourceModifiedDate,omitempty"`
}
