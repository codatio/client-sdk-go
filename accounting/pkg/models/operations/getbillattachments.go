...
type GetBillAttachmentsAttachmentsAttachmentModifiedDate struct {
	// The date on which this record was last modified in Codat.
	ModifiedDate *string `json:"modifiedDate,omitempty"`
}

type GetBillAttachmentsAttachmentsAttachmentSourceModifiedDate struct {
...
type GetBillAttachmentsAttachmentsAttachment struct {
	...
	ModifiedDate       *GetBillAttachmentsAttachmentsAttachmentModifiedDate       `json:"modifiedDate,omitempty"`
	Name               *string                                                    `json:"name,omitempty"`
	SourceModifiedDate *GetBillAttachmentsAttachmentsAttachmentSourceModifiedDate `json:"sourceModifiedDate,omitempty"`
}
