...
func (e *GetSalesOrderSourceModifiedDateInvoicingStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Invoiced":
		fallthrough
	case "NotInvoiced":
		*e = GetSalesOrderSourceModifiedDateInvoicingStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSalesOrderSourceModifiedDateInvoicingStatusEnum: %s", s)
	}
}
...
func (e *GetSalesOrderSourceModifiedDateShipToAddressTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Billing":
		fallthrough
	case "Delivery":
		*e = GetSalesOrderSourceModifiedDateShipToAddressTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSalesOrderSourceModifiedDateShipToAddressTypeEnum: %s", s)
	}
}
...
func (e *GetSalesOrderSourceModifiedDateStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Closed":
		fallthrough
	case "Void":
		*e = GetSalesOrderSourceModifiedDateStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSalesOrderSourceModifiedDateStatusEnum: %s", s)
	}
}
