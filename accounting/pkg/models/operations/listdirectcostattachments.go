...
type ListDirectCostAttachmentsAttachmentsAttachmentModifiedDate struct {
	// The date on which this record was last modified in Codat.
	ModifiedDate *string `json:"modifiedDate,omitempty"`
}

type ListDirectCostAttachmentsAttachmentsAttachmentSourceModifiedDate struct {
...
type ListDirectCostAttachmentsAttachmentsAttachment struct {
	...
	ModifiedDate       *ListDirectCostAttachmentsAttachmentsAttachmentModifiedDate       `json:"modifiedDate,omitempty"`
	Name               *string                                                           `json:"name,omitempty"`
	SourceModifiedDate *ListDirectCostAttachmentsAttachmentsAttachmentSourceModifiedDate `json:"sourceModifiedDate,omitempty"`
}
