...
// GetPaymentSourceModifiedDateAccountRef - Account the payment is recorded against in the accounting platform.
...
// GetPaymentSourceModifiedDateCustomerRef - Customer the payment is recorded against in the accounting platform.
type GetPaymentSourceModifiedDateCustomerRef struct {
	CompanyName *string `json:"companyName,omitempty"`
	ID          string  `json:"id"`
}

// GetPaymentSourceModifiedDateLinesLinksTypeEnum - Types of payment line links
...
func (e *GetPaymentSourceModifiedDateLinesLinksTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "ManualJournal":
		fallthrough
	case "Discount":
		*e = GetPaymentSourceModifiedDateLinesLinksTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPaymentSourceModifiedDateLinesLinksTypeEnum: %s", s)
	}
}
...
// GetPaymentSourceModifiedDatePaymentMethodRef - The Payment Method to which the payment is linked in the accounting platform.
type GetPaymentSourceModifiedDatePaymentMethodRef struct {
	ID   string  `json:"id"`
	Name *string `json:"name,omitempty"`
}

// GetPaymentSourceModifiedDateSupplementalData - Reference to a configured dynamic key value pair that is unique to the accounting platform. This feature is in private beta, contact us if you would like to learn more.
type GetPaymentSourceModifiedDateSupplementalData struct {
	Content map[string]map[string]interface{} `json:"content,omitempty"`
}

// GetPaymentSourceModifiedDate - > **Payments or bill payments?**
// >
