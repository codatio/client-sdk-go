...
func (e *GetPurchaseOrderSourceModifiedDateShipToAddressTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Billing":
		fallthrough
	case "Delivery":
		*e = GetPurchaseOrderSourceModifiedDateShipToAddressTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPurchaseOrderSourceModifiedDateShipToAddressTypeEnum: %s", s)
	}
}
...
func (e *GetPurchaseOrderSourceModifiedDateStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Closed":
		fallthrough
	case "Void":
		*e = GetPurchaseOrderSourceModifiedDateStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPurchaseOrderSourceModifiedDateStatusEnum: %s", s)
	}
}
