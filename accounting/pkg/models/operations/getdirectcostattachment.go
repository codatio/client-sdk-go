...
type GetDirectCostAttachmentAttachmentModifiedDate struct {
	// The date on which this record was last modified in Codat.
	ModifiedDate *string `json:"modifiedDate,omitempty"`
}

type GetDirectCostAttachmentAttachmentSourceModifiedDate struct {
...
type GetDirectCostAttachmentAttachment struct {
	...
	ModifiedDate       *GetDirectCostAttachmentAttachmentModifiedDate       `json:"modifiedDate,omitempty"`
	Name               *string                                              `json:"name,omitempty"`
	SourceModifiedDate *GetDirectCostAttachmentAttachmentSourceModifiedDate `json:"sourceModifiedDate,omitempty"`
}
