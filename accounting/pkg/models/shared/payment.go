...
type PaymentLinesLinksTypeEnum string

const (
	PaymentLinesLinksTypeEnumUnknown          PaymentLinesLinksTypeEnum = "Unknown"
	PaymentLinesLinksTypeEnumUnlinked         PaymentLinesLinksTypeEnum = "Unlinked"
	PaymentLinesLinksTypeEnumInvoice          PaymentLinesLinksTypeEnum = "Invoice"
	PaymentLinesLinksTypeEnumCreditNote       PaymentLinesLinksTypeEnum = "CreditNote"
	PaymentLinesLinksTypeEnumOther            PaymentLinesLinksTypeEnum = "Other"
	PaymentLinesLinksTypeEnumRefund           PaymentLinesLinksTypeEnum = "Refund"
	PaymentLinesLinksTypeEnumPayment          PaymentLinesLinksTypeEnum = "Payment"
	PaymentLinesLinksTypeEnumPaymentOnAccount PaymentLinesLinksTypeEnum = "PaymentOnAccount"
	PaymentLinesLinksTypeEnumManualJournal    PaymentLinesLinksTypeEnum = "ManualJournal"
	PaymentLinesLinksTypeEnumDiscount         PaymentLinesLinksTypeEnum = "Discount"
)

type PaymentLinesLinks struct {
	Amount       *float64                  `json:"amount,omitempty"`
	CurrencyRate *float64                  `json:"currencyRate,omitempty"`
	ID           *string                   `json:"id,omitempty"`
	Type         PaymentLinesLinksTypeEnum `json:"type"`
}

type PaymentLines struct {
	AllocatedOnDate *time.Time          `json:"allocatedOnDate,omitempty"`
	Amount          float64             `json:"amount"`
	Links           []PaymentLinesLinks `json:"links,omitempty"`
}
