...
type CodatLendingSalesPayments struct {
	sdkConfiguration sdkConfiguration
}

func newCodatLendingSalesPayments(sdkConfig sdkConfiguration) *CodatLendingSalesPayments {
	return &CodatLendingSalesPayments{
...
func (s *CodatLendingSalesPayments) Get(ctx context.Context, request operations.GetCommercePaymentRequest, opts ...operations.Option) (*operations.GetCommercePaymentResponse, error) {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *CodatLendingSalesPayments) List(ctx context.Context, request operations.ListCommercePaymentsRequest, opts ...operations.Option) (*operations.ListCommercePaymentsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
