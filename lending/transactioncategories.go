...
func (s *TransactionCategories) Get(ctx context.Context, request operations.GetBankingTransactionCategoryRequest, opts ...operations.Option) (*operations.GetBankingTransactionCategoryResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories/{transactionCategoryId}", request, nil)
	if err != nil {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *TransactionCategories) List(ctx context.Context, request operations.ListBankingTransactionCategoriesRequest, opts ...operations.Option) (*operations.ListBankingTransactionCategoriesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
