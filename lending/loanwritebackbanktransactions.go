...
type loanWritebackBankTransactions struct {
	sdkConfiguration sdkConfiguration
}

func newLoanWritebackBankTransactions(sdkConfig sdkConfiguration) *loanWritebackBankTransactions {
	return &loanWritebackBankTransactions{
...
func (s *loanWritebackBankTransactions) Create(ctx context.Context, request operations.CreateBankTransactionsRequest, opts ...operations.Option) (*operations.CreateBankTransactionsResponse, error) {
...
func (s *loanWritebackBankTransactions) GetCreateModel(ctx context.Context, request operations.GetCreateBankTransactionsModelRequest, opts ...operations.Option) (*operations.GetCreateBankTransactionsModelResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
