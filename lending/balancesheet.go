...
func newBalanceSheet(sdkConfig sdkConfiguration) *BalanceSheet {
	return &BalanceSheet{
...
func (s *BalanceSheet) Get(ctx context.Context, request operations.GetAccountingBalanceSheetRequest, opts ...operations.Option) (*operations.GetAccountingBalanceSheetResponse, error) {
...
func (s *BalanceSheet) GetCategorizedAccounts(ctx context.Context, request operations.GetCategorizedBalanceSheetStatementRequest, opts ...operations.Option) (*operations.GetCategorizedBalanceSheetStatementResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
