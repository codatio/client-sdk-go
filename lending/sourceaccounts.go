...
func (s *SourceAccounts) CreateMapping(ctx context.Context, request operations.CreateBankAccountMappingRequest, opts ...operations.Option) (*operations.CreateBankAccountMappingResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "BankFeedBankAccountMapping", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.BankFeedBankAccountMappingResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.BankFeedBankAccountMappingResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// >
// > Only use this endpoint if you are building your own account management UI.
func (s *SourceAccounts) ListMappings(ctx context.Context, request operations.GetBankAccountMappingRequest, opts ...operations.Option) (*operations.GetBankAccountMappingResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
