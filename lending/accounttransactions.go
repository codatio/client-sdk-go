...
func (s *AccountTransactions) Get(ctx context.Context, request operations.GetAccountingAccountTransactionRequest, opts ...operations.Option) (*operations.GetAccountingAccountTransactionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/accountTransactions/{accountTransactionId}", request, nil)
	if err != nil {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *AccountTransactions) List(ctx context.Context, request operations.ListAccountingAccountTransactionsRequest, opts ...operations.Option) (*operations.ListAccountingAccountTransactionsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/accountTransactions", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
