...
func (a AccountingBillPurchaseOrderReference) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountingBillPurchaseOrderReference) UnmarshalJSON(data []byte) error {
...
func (o *AccountingBillPurchaseOrderReference) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
