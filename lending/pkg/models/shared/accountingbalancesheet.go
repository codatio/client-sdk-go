...
func (o *AccountingBalanceSheet) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
...
func (o *AccountingBalanceSheet) GetEarliestAvailableMonth() *string {
	if o == nil {
		return nil
	}
...
func (o *AccountingBalanceSheet) GetMostRecentAvailableMonth() *string {
	if o == nil {
		return nil
	}
...
func (o *AccountingBalanceSheet) GetReports() []BalanceSheet {
	if o == nil {
		return []BalanceSheet{}
	}
	return o.Reports
