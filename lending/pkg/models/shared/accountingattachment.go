...
// AccountingAttachment - The Codat API supports pulling and pushing of file attachments for invoices, bills, direct costs, and direct incomes.
//
...
func (o *AccountingAttachment) GetContentType() *string {
	if o == nil {
		return nil
	}
...
func (o *AccountingAttachment) GetDateCreated() *string {
	if o == nil {
		return nil
	}
...
func (o *AccountingAttachment) GetFileSize() *int {
	if o == nil {
		return nil
	}
	return o.FileSize
...
func (o *AccountingAttachment) GetIncludeWhenSent() *bool {
	if o == nil {
		return nil
	}
...
func (o *AccountingAttachment) GetModifiedDate() *string {
	if o == nil {
		return nil
	}
...
func (o *AccountingAttachment) GetSourceModifiedDate() *string {
	if o == nil {
		return nil
	}
