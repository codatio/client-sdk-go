...
// AccountingCreateDirectCostResponseDataType - Allowed name of the 'dataType'.
type AccountingCreateDirectCostResponseDataType string

const (
	AccountingCreateDirectCostResponseDataTypeCustomers AccountingCreateDirectCostResponseDataType = "customers"
	AccountingCreateDirectCostResponseDataTypeSuppliers AccountingCreateDirectCostResponseDataType = "suppliers"
)

func (e AccountingCreateDirectCostResponseDataType) ToPointer() *AccountingCreateDirectCostResponseDataType {
	return &e
}

func (e *AccountingCreateDirectCostResponseDataType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "customers":
		fallthrough
	case "suppliers":
		*e = AccountingCreateDirectCostResponseDataType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AccountingCreateDirectCostResponseDataType: %v", v)
	}
}

// AccountingCreateDirectCostResponseContactReference - A customer or supplier associated with the direct cost.
type AccountingCreateDirectCostResponseContactReference struct {
	// Allowed name of the 'dataType'.
	DataType *AccountingCreateDirectCostResponseDataType `json:"dataType,omitempty"`
	// Unique identifier for a customer or supplier.
	ID string `json:"id"`
}

func (o *AccountingCreateDirectCostResponseContactReference) GetDataType() *AccountingCreateDirectCostResponseDataType {
	if o == nil {
		return nil
	}
	return o.DataType
...
func (o *AccountingCreateDirectCostResponseContactReference) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
type AccountingCreateDirectCostResponseAccountingDirectCost struct {
	...
	ContactRef *AccountingCreateDirectCostResponseContactReference `json:"contactRef,omitempty"`
...
func (o *AccountingCreateDirectCostResponseAccountingDirectCost) GetContactRef() *AccountingCreateDirectCostResponseContactReference {
	if o == nil {
		return nil
	}
	return o.ContactRef
