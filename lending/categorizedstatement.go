...
type CategorizedStatement struct {
	sdkConfiguration sdkConfiguration
}

func newCategorizedStatement(sdkConfig sdkConfiguration) *CategorizedStatement {
...
func (s *CategorizedStatement) Get(ctx context.Context, request operations.GetCategorizedBankStatementRequest, opts ...operations.Option) (*operations.GetCategorizedBankStatementResponse, error) {
