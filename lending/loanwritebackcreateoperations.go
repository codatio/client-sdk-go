...
type loanWritebackCreateOperations struct {
...
func (s *loanWritebackCreateOperations) Get(ctx context.Context, request operations.GetCreateOperationRequest, opts ...operations.Option) (*operations.GetCreateOperationResponse, error) {
...
// List create operations.
func (s *loanWritebackCreateOperations) List(ctx context.Context, request operations.ListCreateOperationsRequest, opts ...operations.Option) (*operations.ListCreateOperationsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
