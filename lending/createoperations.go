...
type CreateOperations struct {
	sdkConfiguration sdkConfiguration
}

func newCreateOperations(sdkConfig sdkConfiguration) *CreateOperations {
...
func (s *CreateOperations) Get(ctx context.Context, request operations.GetCreateOperationRequest, opts ...operations.Option) (*operations.GetCreateOperationResponse, error) {
...
// List create operations.
func (s *CreateOperations) List(ctx context.Context, request operations.ListCreateOperationsRequest, opts ...operations.Option) (*operations.ListCreateOperationsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
