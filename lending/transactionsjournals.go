...
type transactionsJournals struct {
	sdkConfiguration sdkConfiguration
}

func newTransactionsJournals(sdkConfig sdkConfiguration) *transactionsJournals {
	return &transactionsJournals{
...
func (s *transactionsJournals) Get(ctx context.Context, request operations.GetAccountingJournalRequest, opts ...operations.Option) (*operations.GetAccountingJournalResponse, error) {
