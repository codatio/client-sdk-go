...
type transactionsJournalEntries struct {
	sdkConfiguration sdkConfiguration
}

func newTransactionsJournalEntries(sdkConfig sdkConfiguration) *transactionsJournalEntries {
	return &transactionsJournalEntries{
...
func (s *transactionsJournalEntries) Get(ctx context.Context, request operations.GetAccountingJournalEntryRequest, opts ...operations.Option) (*operations.GetAccountingJournalEntryResponse, error) {
