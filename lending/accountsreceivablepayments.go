...
type accountsReceivablePayments struct {
	sdkConfiguration sdkConfiguration
}

func newAccountsReceivablePayments(sdkConfig sdkConfiguration) *accountsReceivablePayments {
	return &accountsReceivablePayments{
...
func (s *accountsReceivablePayments) Get(ctx context.Context, request operations.GetAccountingPaymentRequest, opts ...operations.Option) (*operations.GetAccountingPaymentResponse, error) {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *accountsReceivablePayments) List(ctx context.Context, request operations.ListAccountingPaymentsRequest, opts ...operations.Option) (*operations.ListAccountingPaymentsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
