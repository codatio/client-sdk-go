...
type financialStatementsBalanceSheet struct {
	sdkConfiguration sdkConfiguration
}

func newFinancialStatementsBalanceSheet(sdkConfig sdkConfiguration) *financialStatementsBalanceSheet {
	return &financialStatementsBalanceSheet{
...
func (s *financialStatementsBalanceSheet) Get(ctx context.Context, request operations.GetAccountingBalanceSheetRequest, opts ...operations.Option) (*operations.GetAccountingBalanceSheetResponse, error) {
...
func (s *financialStatementsBalanceSheet) GetCategorizedAccounts(ctx context.Context, request operations.GetCategorizedBalanceSheetStatementRequest, opts ...operations.Option) (*operations.GetCategorizedBalanceSheetStatementResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
