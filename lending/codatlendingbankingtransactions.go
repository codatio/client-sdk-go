...
type CodatLendingBankingTransactions struct {
	sdkConfiguration sdkConfiguration
}

func newCodatLendingBankingTransactions(sdkConfig sdkConfiguration) *CodatLendingBankingTransactions {
	return &CodatLendingBankingTransactions{
...
func (s *CodatLendingBankingTransactions) Get(ctx context.Context, request operations.GetBankingTransactionRequest, opts ...operations.Option) (*operations.GetBankingTransactionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/banking-transactions/{transactionId}", request, nil)
	if err != nil {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *CodatLendingBankingTransactions) List(ctx context.Context, request operations.ListBankingTransactionsRequest, opts ...operations.Option) (*operations.ListBankingTransactionsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/banking-transactions", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
