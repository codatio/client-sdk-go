...
type manageDataRefresh struct {
	sdkConfiguration sdkConfiguration
}

func newManageDataRefresh(sdkConfig sdkConfiguration) *manageDataRefresh {
	return &manageDataRefresh{
...
func (s *manageDataRefresh) AllDataTypes(ctx context.Context, request operations.RefreshAllDataTypesRequest, opts ...operations.Option) (*operations.RefreshAllDataTypesResponse, error) {
...
//
// This is an asynchronous operation, and will bring updated data into Codat from the linked integration for you to view.
func (s *manageDataRefresh) DataType(ctx context.Context, request operations.RefreshDataTypeRequest, opts ...operations.Option) (*operations.RefreshDataTypeResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
