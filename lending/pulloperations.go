...
func newPullOperations(sdkConfig sdkConfiguration) *PullOperations {
...
func (s *PullOperations) Get(ctx context.Context, request operations.GetPullOperationRequest, opts ...operations.Option) (*operations.GetPullOperationResponse, error) {
...
func (s *PullOperations) List(ctx context.Context, request operations.ListPullOperationsRequest, opts ...operations.Option) (*operations.ListPullOperationsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
