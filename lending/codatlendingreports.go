...
type CodatLendingReports struct {
	sdkConfiguration sdkConfiguration
}

func newCodatLendingReports(sdkConfig sdkConfiguration) *CodatLendingReports {
	return &CodatLendingReports{
...
func (s *CodatLendingReports) GetOrders(ctx context.Context, request operations.GetCommerceOrdersReportRequest, opts ...operations.Option) (*operations.GetCommerceOrdersReportResponse, error) {
...
//
// The report data then combines multiple reporting dimensions and measures and outputs the value of each combination.
func (s *CodatLendingReports) GetRefunds(ctx context.Context, request operations.GetCommerceRefundsReportRequest, opts ...operations.Option) (*operations.GetCommerceRefundsReportResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
