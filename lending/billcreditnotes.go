...
func (s *BillCreditNotes) Get(ctx context.Context, request operations.GetAccountingBillCreditNoteRequest, opts ...operations.Option) (*operations.GetAccountingBillCreditNoteResponse, error) {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *BillCreditNotes) List(ctx context.Context, request operations.ListAccountingBillCreditNotesRequest, opts ...operations.Option) (*operations.ListAccountingBillCreditNotesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
