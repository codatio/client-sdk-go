...
type salesPaymentMethods struct {
	sdkConfiguration sdkConfiguration
}

func newSalesPaymentMethods(sdkConfig sdkConfiguration) *salesPaymentMethods {
	return &salesPaymentMethods{
...
func (s *salesPaymentMethods) Get(ctx context.Context, request operations.GetCommercePaymentMethodRequest, opts ...operations.Option) (*operations.GetCommercePaymentMethodResponse, error) {
