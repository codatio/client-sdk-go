...
func (s *CreditNotes) Get(ctx context.Context, request operations.GetAccountingCreditNoteRequest, opts ...operations.Option) (*operations.GetAccountingCreditNoteResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/data/creditNotes/{creditNoteId}", request, nil)
	if err != nil {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *CreditNotes) List(ctx context.Context, request operations.ListAccountingCreditNotesRequest, opts ...operations.Option) (*operations.ListAccountingCreditNotesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/data/creditNotes", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
