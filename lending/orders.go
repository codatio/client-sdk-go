...
func (s *Orders) Get(ctx context.Context, request operations.GetCommerceOrderRequest, opts ...operations.Option) (*operations.GetCommerceOrderResponse, error) {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *Orders) List(ctx context.Context, request operations.ListCommerceOrdersRequest, opts ...operations.Option) (*operations.ListCommerceOrdersResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
