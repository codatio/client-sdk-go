...
func main() {
    ...
    res, err := s.LoanWriteback.DirectCosts.Create(ctx, operations.CreateDirectCostRequest{
            ...
            LineItems: []shared.DirectCostLineItem{
                shared.DirectCostLineItem{
                    AccountRef: &shared.AccountRef{
                        ID: lending.String("<ID>"),
                        Name: lending.String("Money blue shred"),
                    },
                    Description: lending.String("Implemented web-enabled success"),
                    DiscountAmount: types.MustNewDecimalFromString("0.86"),
                    DiscountPercentage: types.MustNewDecimalFromString("4552.22"),
                    ItemRef: &shared.ItemRef{
                        ID: "<ID>",
                        Name: lending.String("evolve"),
                    },
                    ...
                    TaxRateRef: &shared.TaxRateRef{
                        ...
                        ID: lending.String("<ID>"),
                        Name: lending.String("Screen mobile"),
                    },
        ...
        TimeoutInMinutes: lending.Int(425694),
    })
    if err != nil {
        log.Fatal(err)
    }
