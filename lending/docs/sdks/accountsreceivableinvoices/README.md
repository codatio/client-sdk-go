...
func main() {
    ...
    res, err := s.AccountsReceivable.Invoices.List(ctx, operations.ListAccountingInvoicesRequest{
        ...
        Query: lending.String("occaecati"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.ListReconciledInvoicesResponse](../../models/operations/listreconciledinvoicesresponse.md), error**
