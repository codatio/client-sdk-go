...
type CodatLendingTransfers struct {
	sdkConfiguration sdkConfiguration
}

func newCodatLendingTransfers(sdkConfig sdkConfiguration) *CodatLendingTransfers {
	return &CodatLendingTransfers{
...
func (s *CodatLendingTransfers) Get(ctx context.Context, request operations.GetAccountingTransferRequest, opts ...operations.Option) (*operations.GetAccountingTransferResponse, error) {
...
//
// Before using this endpoint, you must have [retrieved data for the company](https://docs.codat.io/lending-api#/operations/refresh-company-data).
func (s *CodatLendingTransfers) List(ctx context.Context, request operations.ListAccountingTransfersRequest, opts ...operations.Option) (*operations.ListAccountingTransfersResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
