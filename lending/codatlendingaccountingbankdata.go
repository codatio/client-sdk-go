...
// CodatLendingAccountingBankData - Access bank transactions from an accounting software.
type CodatLendingAccountingBankData struct {
	Accounts *Accounts

	sdkConfiguration sdkConfiguration
}

func newCodatLendingAccountingBankData(sdkConfig sdkConfiguration) *CodatLendingAccountingBankData {
	return &CodatLendingAccountingBankData{
...
func (s *CodatLendingAccountingBankData) ListTransactions(ctx context.Context, request operations.ListAccountingBankAccountTransactionsRequest, opts ...operations.Option) (*operations.ListAccountingBankAccountTransactionsResponse, error) {
