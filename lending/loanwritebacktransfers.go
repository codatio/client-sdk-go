...
type loanWritebackTransfers struct {
	sdkConfiguration sdkConfiguration
}

func newLoanWritebackTransfers(sdkConfig sdkConfiguration) *loanWritebackTransfers {
...
func (s *loanWritebackTransfers) Create(ctx context.Context, request operations.CreateTransferRequest, opts ...operations.Option) (*operations.CreateTransferResponse, error) {
...
func (s *loanWritebackTransfers) GetCreateModel(ctx context.Context, request operations.GetCreateTransfersModelRequest, opts ...operations.Option) (*operations.GetCreateTransfersModelResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
