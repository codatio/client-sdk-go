...
func newBankingAccounts(sdkConfig sdkConfiguration) *bankingAccounts {
...
func (s *bankingAccounts) Get(ctx context.Context, request operations.GetBankingAccountRequest, opts ...operations.Option) (*operations.GetBankingAccountResponse, error) {
