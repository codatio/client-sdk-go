...
type manageDataPullOperations struct {
	sdkConfiguration sdkConfiguration
}

func newManageDataPullOperations(sdkConfig sdkConfiguration) *manageDataPullOperations {
	return &manageDataPullOperations{
...
func (s *manageDataPullOperations) Get(ctx context.Context, request operations.GetPullOperationRequest, opts ...operations.Option) (*operations.GetPullOperationResponse, error) {
