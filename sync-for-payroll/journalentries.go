...
import (
	...
	"github.com/codatio/client-sdk-go/sync-for-payroll/internal/hooks"
...
// JournalEntries - Get, create, and update Journal entries.
...
func (s *JournalEntries) Create(ctx context.Context, request operations.CreateJournalEntryRequest, opts ...operations.Option) (*operations.CreateJournalEntryResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/push/journalEntries", request, nil)
	if err != nil {
...
func (s *JournalEntries) Delete(ctx context.Context, request operations.DeleteJournalEntryRequest, opts ...operations.Option) (*operations.DeleteJournalEntryResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/push/journalEntries/{journalEntryId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *JournalEntries) GetCreateModel(ctx context.Context, request operations.GetCreateJournalEntryModelRequest, opts ...operations.Option) (*operations.GetCreateJournalEntryModelResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/options/journalEntries", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
