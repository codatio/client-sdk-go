...
func main() {
    ...
    res, err := s.JournalEntries.Create(ctx, operations.CreateJournalEntryRequest{
        JournalEntry: &shared.JournalEntry{
            ...
            Description: syncforpayroll.String("ab"),
            ID: syncforpayroll.String("51a05dfc-2ddf-47cc-b8ca-1ba928fc8167"),
            JournalLines: []shared.JournalLine{
                shared.JournalLine{
                    AccountRef: &shared.AccountRef{
                        ID: syncforpayroll.String("42cb7392-0592-4939-afea-7596eb10faaa"),
                        Name: syncforpayroll.String("Connie Herzog"),
                    },
                    Currency: syncforpayroll.String("enim"),
                    Description: syncforpayroll.String("omnis"),
                    NetAmount: types.MustNewDecimalFromString("3637.11"),
                    Tracking: &shared.JournalLineTracking{
                        RecordRefs: []shared.RecordRef{
                            shared.RecordRef{
                                DataType: syncforpayroll.String("invoice"),
                                ID: syncforpayroll.String("907aff1a-3a2f-4a94-a773-9251aa52c3f5"),
                            },
                        },
                    },
                },
            ...
            JournalRef: &shared.JournalRef{
                ...
                Name: syncforpayroll.String("Elvira Bergnaum"),
            },
...
func main() {
    ...
    res, err := s.JournalEntries.List(ctx, operations.ListJournalEntriesRequest{
        ...
        Query: syncforpayroll.String("eligendi"),
    })
    if err != nil {
        log.Fatal(err)
    }
