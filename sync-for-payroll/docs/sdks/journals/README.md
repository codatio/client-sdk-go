...
func main() {
    ...
    res, err := s.Journals.Create(ctx, operations.CreateJournalRequest{
        Journal: &shared.Journal{
            ...
            ID: syncforpayroll.String("69e9a3ef-a77d-4fb1-8cd6-6ae395efb9ba"),
            JournalCode: syncforpayroll.String("blanditiis"),
            Metadata: &shared.Metadata{
                IsDeleted: syncforpayroll.Bool(false),
            },
            ModifiedDate: syncforpayroll.String("2022-10-23T00:00:00.000Z"),
            Name: syncforpayroll.String("Vincent Nolan"),
            ParentID: syncforpayroll.String("natus"),
            SourceModifiedDate: syncforpayroll.String("2022-10-23T00:00:00.000Z"),
            Status: shared.JournalStatusActive.ToPointer(),
            Type: syncforpayroll.String("perferendis"),
        },
        CompanyID: "8a210b68-6988-11ed-a1eb-0242ac120002",
        ConnectionID: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
        TimeoutInMinutes: syncforpayroll.Int(470132),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Journals.List(ctx, operations.ListJournalsRequest{
        ...
        Query: syncforpayroll.String("distinctio"),
    })
    if err != nil {
        log.Fatal(err)
    }
