...
type UpdateBillResponseAllocation struct {
...
func (u UpdateBillResponseAllocation) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateBillResponseAllocation) UnmarshalJSON(data []byte) error {
...
func (o *UpdateBillResponseAllocation) GetAllocatedOnDate() *string {
	if o == nil {
		return nil
	}
...
func (o *UpdateBillResponseAllocation) GetCurrency() *string {
	if o == nil {
		return nil
	}
	return o.Currency
...
func (o *UpdateBillResponseAllocation) GetCurrencyRate() *decimal.Big {
	if o == nil {
		return nil
	}
...
func (o *UpdateBillResponseAllocation) GetTotalAmount() *decimal.Big {
	if o == nil {
		return nil
	}
...
type UpdateBillResponseAccountingPaymentAllocation struct {
	Allocation UpdateBillResponseAllocation `json:"allocation"`
	Payment    PaymentAllocationPayment     `json:"payment"`
}

func (o *UpdateBillResponseAccountingPaymentAllocation) GetAllocation() UpdateBillResponseAllocation {
	if o == nil {
		return UpdateBillResponseAllocation{}
	}
	return o.Allocation
}

func (o *UpdateBillResponseAccountingPaymentAllocation) GetPayment() PaymentAllocationPayment {
	if o == nil {
...
type UpdateBillResponsePurchaseOrderReference struct {
...
func (o *UpdateBillResponsePurchaseOrderReference) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *UpdateBillResponsePurchaseOrderReference) GetPurchaseOrderNumber() *string {
	if o == nil {
		return nil
	}
...
type UpdateBillResponseAccountingBill struct {
	...
	PaymentAllocations []UpdateBillResponseAccountingPaymentAllocation `json:"paymentAllocations,omitempty"`
	PurchaseOrderRefs  []UpdateBillResponsePurchaseOrderReference      `json:"purchaseOrderRefs,omitempty"`
...
func (o *UpdateBillResponseAccountingBill) GetPaymentAllocations() []UpdateBillResponseAccountingPaymentAllocation {
	if o == nil {
		return nil
	}
...
func (o *UpdateBillResponseAccountingBill) GetPurchaseOrderRefs() []UpdateBillResponsePurchaseOrderReference {
	if o == nil {
		return nil
	}
