...
// AccountingJournalEntries - Retrieve standardized Journal entries from linked accounting software.
...
func (s *AccountingJournalEntries) CreateAccountingJournalEntry(ctx context.Context, request operations.CreateAccountingJournalEntryRequest, opts ...operations.Option) (*operations.CreateAccountingJournalEntryResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, true, true, "AccountingJournalEntry", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateAccountingJournalEntryResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AccountingCreateJournalEntryResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccountingCreateJournalEntryResponse = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
