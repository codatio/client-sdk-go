...
func main() {
    ...
    res, err := s.CommerceLocations.GetCommerceLocation(ctx, operations.GetCommerceLocationRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.CommerceLocations.ListCommerceLocations(ctx, operations.ListCommerceLocationsRequest{
        CompanyID: "8a210b68-6988-11ed-a1eb-0242ac120002",
        ConnectionID: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    })
    if err != nil {
