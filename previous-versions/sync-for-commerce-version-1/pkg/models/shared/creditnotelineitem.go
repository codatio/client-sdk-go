...
type CreditNoteLineItemRecordReference struct {
...
func (o *CreditNoteLineItemRecordReference) GetDataType() *string {
	if o == nil {
		return nil
	}
	return o.DataType
...
func (o *CreditNoteLineItemRecordReference) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
type CreditNoteLineItemTracking struct {
	...
	//
	// For example, if a journal entry is generated based on an invoice, this property allows you to connect the journal entry to the underlying invoice in our data model.
	RecordRef *CreditNoteLineItemRecordReference `json:"recordRef,omitempty"`
}
...
func (o *CreditNoteLineItemTracking) GetRecordRef() *CreditNoteLineItemRecordReference {
	if o == nil {
		return nil
	}
	return o.RecordRef
