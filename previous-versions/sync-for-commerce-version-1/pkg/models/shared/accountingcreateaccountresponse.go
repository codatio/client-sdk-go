...
type AccountingCreateAccountResponseMetadata struct {
	// Indicates whether the record has been deleted in the third-party system this record originated from.
	IsDeleted *bool `json:"isDeleted,omitempty"`
}

func (o *AccountingCreateAccountResponseMetadata) GetIsDeleted() *bool {
	if o == nil {
		return nil
	}
	return o.IsDeleted
...
type AccountingCreateAccountResponseAccountingAccount struct {
	...
	Metadata      *AccountingCreateAccountResponseMetadata `json:"metadata,omitempty"`
...
func (o *AccountingCreateAccountResponseAccountingAccount) GetMetadata() *AccountingCreateAccountResponseMetadata {
	if o == nil {
		return nil
	}
	return o.Metadata
