...
func (s *SyncFlowPreferences) GetConfigTextSyncFlow(ctx context.Context, request operations.GetConfigTextSyncFlowRequest, opts ...operations.Option) (*operations.GetConfigTextSyncFlowResponse, error) {
...
func (s *SyncFlowPreferences) GetSyncFlowURL(ctx context.Context, request operations.GetSyncFlowURLRequest, opts ...operations.Option) (*operations.GetSyncFlowURLResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/config/sync/commerce/{commerceKey}/{accountingKey}/start", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *SyncFlowPreferences) UpdateConfigTextSyncFlow(ctx context.Context, request operations.UpdateConfigTextSyncFlowRequest, opts ...operations.Option) (*operations.UpdateConfigTextSyncFlowResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
