...
// AccountingCompanyInfo - Retrieve standardized Accounting company info from linked accounting software.
...
func (s *AccountingCompanyInfo) GetAccountingCompanyInfo(ctx context.Context, request operations.GetAccountingCompanyInfoRequest, opts ...operations.Option) (*operations.GetAccountingCompanyInfoResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AccountingCompanyDataset
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccountingCompanyDataset = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
