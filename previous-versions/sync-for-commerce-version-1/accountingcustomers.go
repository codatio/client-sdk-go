...
// AccountingCustomers - Retrieve standardized Customers from linked accounting software.
...
func (s *AccountingCustomers) CreateAccountingCustomer(ctx context.Context, request operations.CreateAccountingCustomerRequest, opts ...operations.Option) (*operations.CreateAccountingCustomerResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, true, true, "AccountingCustomer", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AccountingCreateCustomerResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccountingCreateCustomerResponse = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
