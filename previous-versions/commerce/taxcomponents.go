...
// TaxComponents - Retrieve standardized data from linked commerce software.
...
func (s *TaxComponents) Get(ctx context.Context, request operations.GetTaxComponentRequest, opts ...operations.Option) (*operations.GetTaxComponentResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/commerce-taxComponents/{taxId}", request, nil)
	if err != nil {
...
func (s *TaxComponents) List(ctx context.Context, request operations.ListTaxComponentsRequest, opts ...operations.Option) (*operations.ListTaxComponentsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/commerce-taxComponents", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
