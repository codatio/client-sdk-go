...
func main() {
    ...
    res, err := s.Payments.Create(ctx, operations.CreatePaymentRequest{
        Payment: &shared.Payment{
            ...
            CurrencyRate: codataccounting.Float64(161.58),
                ...
                shared.PaymentLine{
                    ...
                    Links: []shared.PaymentLineLink{
                        shared.PaymentLineLink{
                            Amount: codataccounting.Float64(5576.51),
                            CurrencyRate: codataccounting.Float64(3385.42),
            ...
            TotalAmount: codataccounting.Float64(2883.48),
        },
