...
func main() {
    ...
    res, err := s.BankAccounts.Create(ctx, operations.CreateBankAccountRequest{
        BankAccount: &shared.BankAccount{
            ...
            AvailableBalance: codataccounting.Float64(5218.48),
            Balance: codataccounting.Float64(1059.07),
            ...
            OverdraftLimit: codataccounting.Float64(1289.26),
...
func main() {
    ...
    res, err := s.BankAccounts.Update(ctx, operations.UpdateBankAccountRequest{
        BankAccount: &shared.BankAccount{
            ...
            AvailableBalance: codataccounting.Float64(6342.74),
            Balance: codataccounting.Float64(9883.74),
            ...
            OverdraftLimit: codataccounting.Float64(8781.94),
