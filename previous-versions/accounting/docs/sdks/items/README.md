        ...
        Item: &shared.Item{
            BillItem: &shared.BillItem{
                AccountRef: &shared.AccountRef{
                    ID: accounting.String("33e66bd8-fe5d-400b-979e-f20387320590"),
                    Name: accounting.String("Mr. Forrest Ryan"),
                },
                Description: accounting.String("ea"),
                TaxRateRef: &shared.TaxRateRef{
                    EffectiveTaxRate: types.MustNewDecimalFromString("2622.31"),
                    ID: accounting.String("00313b3e-5044-4f65-be72-dc4077d0cc3f"),
                    Name: accounting.String("Carol Lowe"),
                },
                UnitPrice: types.MustNewDecimalFromString("7738.54"),
            },
            Code: accounting.String("dicta"),
            ID: accounting.String("5ceb4d6e-1eae-40f7-9aed-f2acab58b991"),
            InvoiceItem: &shared.InvoiceItem{
                AccountRef: &shared.AccountRef{
                    ID: accounting.String("c926ddb5-8946-41e7-821c-be6d9502f0ea"),
                    Name: accounting.String("Sean Auer"),
                },
