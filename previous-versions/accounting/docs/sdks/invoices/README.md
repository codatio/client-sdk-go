...
func main() {
    ...
    res, err := s.Invoices.Create(ctx, operations.CreateInvoiceRequest{
        Invoice: &shared.Invoice{
            AdditionalTaxAmount: codataccounting.Float64(263.21),
            AdditionalTaxPercentage: codataccounting.Float64(8197.57),
            AmountDue: 7188.79,
            Currency: codataccounting.String("EUR"),
            CurrencyRate: codataccounting.Float64(8256.81),
            CustomerRef: &shared.AccountingCustomerRef{
                CompanyName: codataccounting.String("illum"),
                ID: "b484708f-b4e3-491e-abc1-58c4c4e54599",
            },
            DiscountPercentage: codataccounting.Float64(9294.43),
            ...
            LineItems: []shared.InvoiceLineItem{
                shared.InvoiceLineItem{
                    ...
                    DiscountAmount: codataccounting.Float64(5920.88),
                    DiscountPercentage: codataccounting.Float64(5818.89),
                    ...
                    Quantity: 4608.03,
                    SubTotal: codataccounting.Float64(3920.8),
                    TaxAmount: codataccounting.Float64(1296.19),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: codataccounting.Float64(1974.41),
                        ID: codataccounting.String("0f841fb1-bd23-4fdb-94db-6be5a685998e"),
                        Name: codataccounting.String("Wanda Osinski"),
                    },
                    TotalAmount: codataccounting.Float64(276.53),
            ...
            PaymentAllocations: []shared.Items{
                shared.Items{
                    Allocation: shared.ItemsAllocation{
                        ...
                        Currency: codataccounting.String("EUR"),
                        CurrencyRate: codataccounting.Float64(5062.02),
                        TotalAmount: codataccounting.Float64(5749.9),
                    },
                    Payment: shared.PaymentAllocationPayment{
                        ...
                        Currency: codataccounting.String("EUR"),
                        CurrencyRate: codataccounting.Float64(6104.9),
                        ...
                        TotalAmount: codataccounting.Float64(7036.51),
                    },
                },
            },
            ...
            SubTotal: codataccounting.Float64(2033.96),
            ...
            TotalAmount: 3198.07,
            TotalDiscount: codataccounting.Float64(9545.95),
...
func main() {
    ...
    res, err := s.Invoices.Update(ctx, operations.UpdateInvoiceRequest{
        Invoice: &shared.Invoice{
            AdditionalTaxAmount: codataccounting.Float64(3227.73),
            AdditionalTaxPercentage: codataccounting.Float64(8477.4),
            AmountDue: 229.66,
            Currency: codataccounting.String("USD"),
            CurrencyRate: codataccounting.Float64(3771.94),
            CustomerRef: &shared.AccountingCustomerRef{
                CompanyName: codataccounting.String("expedita"),
                ID: "6f66fef0-20e9-4f44-bb42-57b992c8dbda",
            },
            DiscountPercentage: codataccounting.Float64(4146.44),
            DueDate: codataccounting.String("2022-10-23T00:00:00.000Z"),
            ...
            LineItems: []shared.InvoiceLineItem{
                shared.InvoiceLineItem{
                    ...
                    DiscountAmount: codataccounting.Float64(3396.51),
                    DiscountPercentage: codataccounting.Float64(7343.61),
                    IsDirectIncome: codataccounting.Bool(false),
                    ItemRef: &shared.ItemRef{
                    ...
                    Quantity: 4397.45,
                    SubTotal: codataccounting.Float64(6541.99),
                    TaxAmount: codataccounting.Float64(105.85),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: codataccounting.Float64(9164.86),
            ...
            PaymentAllocations: []shared.Items{
                shared.Items{
                    Allocation: shared.ItemsAllocation{
                        ...
                        CurrencyRate: codataccounting.Float64(9580.6),
                        TotalAmount: codataccounting.Float64(3371.49),
                    },
                    Payment: shared.PaymentAllocationPayment{
                        AccountRef: &shared.AccountRef{
                        ...
                        Currency: codataccounting.String("GBP"),
                        CurrencyRate: codataccounting.Float64(7370.61),
                        ...
                        TotalAmount: codataccounting.Float64(2628.91),
                    },
                },
            },
            SalesOrderRefs: []shared.SalesOrderRef{
            ...
            SourceModifiedDate: codataccounting.String("2022-10-23T00:00:00.000Z"),
            Status: shared.InvoiceStatusSubmitted,
            SubTotal: codataccounting.Float64(4990.05),
            SupplementalData: &shared.SupplementalData{
                Content: map[string]map[string]interface{}{
            ...
            TotalAmount: 5463.29,
            TotalDiscount: codataccounting.Float64(4724.29),
