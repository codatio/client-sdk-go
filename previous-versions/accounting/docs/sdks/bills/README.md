...
func main() {
    ...
    res, err := s.Bills.Create(ctx, operations.CreateBillRequest{
        Bill: &shared.Bill{
            AmountDue: codataccounting.Float64(5436.78),
            Currency: codataccounting.String("GBP"),
            CurrencyRate: codataccounting.Float64(2826.99),
            ...
            LineItems: []shared.BillLineItem{
                shared.BillLineItem{
                    ...
                    DiscountAmount: codataccounting.Float64(4103.01),
                    DiscountPercentage: codataccounting.Float64(5391.18),
                    ...
                    Quantity: 1604.67,
                    SubTotal: codataccounting.Float64(5801.07),
                    TaxAmount: codataccounting.Float64(8863.05),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: codataccounting.Float64(5979.37),
                        ID: codataccounting.String("73e922a5-7a15-4be3-a060-807e2b6e3ab8"),
                        Name: codataccounting.String("Jim Hammes II"),
                    },
                    TotalAmount: codataccounting.Float64(5973.03),
            ...
            PaymentAllocations: []shared.BillPaymentAllocation{
                shared.BillPaymentAllocation{
                    Allocation: shared.BillPaymentAllocationAllocation{
                        ...
                        CurrencyRate: codataccounting.Float64(3747.53),
                        TotalAmount: codataccounting.Float64(6145.28),
                    },
                    Payment: shared.PaymentAllocationPayment{
                        ...
                        CurrencyRate: codataccounting.Float64(291.9),
                        ...
                        TotalAmount: codataccounting.Float64(2226.58),
                    },
                },
            },
...
func main() {
    ...
    res, err := s.Bills.Update(ctx, operations.UpdateBillRequest{
        Bill: &shared.Bill{
            AmountDue: codataccounting.Float64(9308.19),
            Currency: codataccounting.String("USD"),
            CurrencyRate: codataccounting.Float64(5207.61),
            DueDate: codataccounting.String("2022-10-23T00:00:00.000Z"),
            ...
            LineItems: []shared.BillLineItem{
                shared.BillLineItem{
                    ...
                    DiscountAmount: codataccounting.Float64(1076.17),
                    DiscountPercentage: codataccounting.Float64(8777.51),
                    IsDirectCost: codataccounting.Bool(false),
                    ItemRef: &shared.ItemRef{
                    ...
                    Quantity: 8975.43,
                    SubTotal: codataccounting.Float64(6540.82),
                    TaxAmount: codataccounting.Float64(7699.67),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: codataccounting.Float64(3730.4),
                        ID: codataccounting.String("5a9741d3-1135-4296-9bb8-a7202611435e"),
                        Name: codataccounting.String("Tracy Mills"),
                    },
                    TotalAmount: codataccounting.Float64(8028.94),
                    Tracking: &shared.Propertiestracking{
                        CategoryRefs: []shared.TrackingCategoryRef{
                            shared.TrackingCategoryRef{
            ...
            PaymentAllocations: []shared.BillPaymentAllocation{
                shared.BillPaymentAllocation{
                    Allocation: shared.BillPaymentAllocationAllocation{
                        AllocatedOnDate: codataccounting.String("2022-10-23T00:00:00.000Z"),
                        Currency: codataccounting.String("USD"),
                        CurrencyRate: codataccounting.Float64(2114.55),
                        TotalAmount: codataccounting.Float64(2646.19),
                    },
                    Payment: shared.PaymentAllocationPayment{
                        AccountRef: &shared.AccountRef{
                        ...
                        Currency: codataccounting.String("USD"),
                        CurrencyRate: codataccounting.Float64(5646.67),
                        ...
                        TotalAmount: codataccounting.Float64(8138.8),
                    },
                },
            },
            PurchaseOrderRefs: []shared.PurchaseOrderRef{
