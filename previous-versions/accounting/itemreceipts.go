...
func (s *ItemReceipts) Get(ctx context.Context, request operations.GetItemReceiptRequest, opts ...operations.Option) (*operations.GetItemReceiptResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/itemReceipts/{itemReceiptId}", request, nil)
	if err != nil {
...
func (s *ItemReceipts) List(ctx context.Context, request operations.ListItemReceiptsRequest, opts ...operations.Option) (*operations.ListItemReceiptsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/data/itemReceipts", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
