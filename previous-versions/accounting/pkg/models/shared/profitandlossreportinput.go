...
type ProfitAndLossReportInput struct {
...
func (o *ProfitAndLossReportInput) GetCurrency() string {
	if o == nil {
		return ""
	}
	return o.Currency
...
func (o *ProfitAndLossReportInput) GetEarliestAvailableMonth() *string {
	if o == nil {
		return nil
	}
...
func (o *ProfitAndLossReportInput) GetMostRecentAvailableMonth() *string {
	if o == nil {
		return nil
	}
...
func (o *ProfitAndLossReportInput) GetReportBasis() ReportBasis {
	if o == nil {
		return ReportBasis("")
	}
...
func (o *ProfitAndLossReportInput) GetReports() []ProfitAndLossReport {
	if o == nil {
