...
// ProfitAndLossReport1 - > **Language tip:** Profit and loss statement is also referred to as **income statement** under US GAAP (Generally Accepted Accounting Principles).
//
...
type ProfitAndLossReport1 struct {
