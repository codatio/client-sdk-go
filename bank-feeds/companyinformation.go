...
// CompanyInformation - Get detailed information about a company from the underlying accounting software.
type CompanyInformation struct {
	sdkConfiguration sdkConfiguration
}

func newCompanyInformation(sdkConfig sdkConfiguration) *CompanyInformation {
...
func (s *CompanyInformation) Get(ctx context.Context, request operations.GetCompanyInformationRequest, opts ...operations.Option) (*operations.GetCompanyInformationResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/bankFeeds/info", request, nil)
	if err != nil {
	...
	res := &operations.GetCompanyInformationResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.CompanyInformation
