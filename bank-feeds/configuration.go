...
// Configuration - Configure bank feeds for a company.
...
func (s *Configuration) Get(ctx context.Context, request operations.GetConfigurationRequest, opts ...operations.Option) (*operations.GetConfigurationResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/sync/banking/config", request, nil)
	if err != nil {
...
func (s *Configuration) Set(ctx context.Context, request operations.SetConfigurationRequest, opts ...operations.Option) (*operations.SetConfigurationResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "Configuration", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
