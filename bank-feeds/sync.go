...
func (s *Sync) GetLastSuccessfulSync(ctx context.Context, request operations.GetLastSuccessfulRequest, opts ...operations.Option) (*operations.GetLastSuccessfulResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "get-last-successful",
		OAuth2Scopes:   []string{},
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/sync/banking/syncs/lastSuccessful/status", request, nil)
	if err != nil {
	...
	res := &operations.GetLastSuccessfulResponse{
