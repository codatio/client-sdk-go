...
func (s *categories) GetAccountCategory(ctx context.Context, request operations.GetAccountCategoryRequest) (*operations.GetAccountCategoryResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/data/companies/{companyId}/connections/{connectionId}/assess/accounts/{accountId}/categories", request.PathParams, nil)
...
func (s *categories) ListAccountsCategories(ctx context.Context, request operations.ListAccountsCategoriesRequest) (*operations.ListAccountsCategoriesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/data/companies/{companyId}/connections/{connectionId}/assess/accounts/categories", request.PathParams, nil)
