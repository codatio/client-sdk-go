...
// GetCommerceRevenueMetricsPeriodUnitEnum - The period unit of time returned.
...
func (e *GetCommerceRevenueMetricsPeriodUnitEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Month":
		fallthrough
	case "Year":
		*e = GetCommerceRevenueMetricsPeriodUnitEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommerceRevenueMetricsPeriodUnitEnum: %s", s)
	}
}
...
// GetCommerceRevenueMetrics200ApplicationJSON - Assess reports follow a consistent structure. Reports contain four sections of information:
//
