...
// GetCommerceLifetimeValueMetricsPeriodUnitEnum - The period unit of time returned.
...
func (e *GetCommerceLifetimeValueMetricsPeriodUnitEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Month":
		fallthrough
	case "Year":
		*e = GetCommerceLifetimeValueMetricsPeriodUnitEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommerceLifetimeValueMetricsPeriodUnitEnum: %s", s)
	}
}
...
// GetCommerceLifetimeValueMetrics200ApplicationJSON - Assess reports follow a consistent structure. Reports contain four sections of information:
//
