...
// GetCommerceCustomerRetentionMetricsPeriodUnitEnum - The period unit of time returned.
...
func (e *GetCommerceCustomerRetentionMetricsPeriodUnitEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Month":
		fallthrough
	case "Year":
		*e = GetCommerceCustomerRetentionMetricsPeriodUnitEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommerceCustomerRetentionMetricsPeriodUnitEnum: %s", s)
	}
}
...
// GetCommerceCustomerRetentionMetrics200ApplicationJSON - Assess reports follow a consistent structure. Reports contain four sections of information:
//
