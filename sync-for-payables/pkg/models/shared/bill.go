...
func (o *BillPaymentAllocationAllocation) GetCurrencyRate() *types.Decimal {
	if o == nil {
		return nil
	}
...
func (o *BillPaymentAllocationAllocation) GetTotalAmount() *types.Decimal {
	if o == nil {
		return nil
	}
...
type BillPurchaseOrderReference struct {
...
func (o *BillPurchaseOrderReference) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *BillPurchaseOrderReference) GetPurchaseOrderNumber() *string {
	if o == nil {
		return nil
	}
...
func (o *BillWithholdingTax) GetAmount() types.Decimal {
	if o == nil {
...
type Bill struct {
	...
	PurchaseOrderRefs  []BillPurchaseOrderReference `json:"purchaseOrderRefs,omitempty"`
...
func (o *Bill) GetAmountDue() *types.Decimal {
	if o == nil {
		return nil
	}
	return o.AmountDue
...
func (o *Bill) GetCurrencyRate() *types.Decimal {
	if o == nil {
		return nil
	}
	return o.CurrencyRate
...
func (o *Bill) GetPurchaseOrderRefs() []BillPurchaseOrderReference {
	if o == nil {
		return nil
	}
...
func (o *Bill) GetSubTotal() types.Decimal {
	if o == nil {
		return types.Decimal{Big: *(new(decimal.Big).SetFloat64(0.0))}
	}
	return o.SubTotal
...
func (o *Bill) GetTaxAmount() types.Decimal {
	if o == nil {
		return types.Decimal{Big: *(new(decimal.Big).SetFloat64(0.0))}
	}
	return o.TaxAmount
...
func (o *Bill) GetTotalAmount() types.Decimal {
	if o == nil {
		return types.Decimal{Big: *(new(decimal.Big).SetFloat64(0.0))}
	}
	return o.TotalAmount
