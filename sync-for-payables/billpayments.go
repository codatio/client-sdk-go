...
// GetPaymentOptions - Get payment mapping options
...
func (s *BillPayments) GetPaymentOptions(ctx context.Context, request operations.GetMappingOptionsPaymentsRequest, opts ...operations.Option) (*operations.GetMappingOptionsPaymentsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/payables/mappingOptions/payments", request, nil)
	if err != nil {
	...
	res := &operations.GetMappingOptionsPaymentsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PaymentMappingOptions
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PaymentMappingOptions = &out
		default:
			rawBody, err := getRawBody()
			if err != nil {
				return nil, err
...
func (s *BillPayments) Create(ctx context.Context, request operations.CreateBillPaymentRequest, opts ...operations.Option) (*operations.CreateBillPaymentResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/payables/bills/{billId}/payment", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "BillPaymentPrototype", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
