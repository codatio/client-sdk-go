...
func main() {
    ...
    res, err := s.BillCreditNotes.Create(ctx, operations.CreateBillCreditNoteRequest{
        BillCreditNote: &shared.BillCreditNote{
            ...
            CurrencyRate: codatsyncpayables.Float64(3834.41),
            ...
            LineItems: []shared.BillCreditNoteLineItem{
                shared.BillCreditNoteLineItem{
                    ...
                    DiscountAmount: codatsyncpayables.Float64(1059.07),
                    DiscountPercentage: codatsyncpayables.Float64(4146.62),
                    ...
                    Quantity: 7506.86,
                    SubTotal: codatsyncpayables.Float64(3154.28),
                    TaxAmount: codatsyncpayables.Float64(6078.31),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: codatsyncpayables.Float64(3637.11),
                        ID: codatsyncpayables.String("5907aff1-a3a2-4fa9-8677-39251aa52c3f"),
                        Name: codatsyncpayables.String("Mr. Alberta Schuster"),
                    },
                    TotalAmount: codatsyncpayables.Float64(8379.45),
            ...
            PaymentAllocations: []shared.Items{
                shared.Items{
                    Allocation: shared.ItemsAllocation{
                        ...
                        CurrencyRate: codatsyncpayables.Float64(972.6),
                        TotalAmount: codatsyncpayables.Float64(4358.65),
                    },
                    Payment: shared.PaymentAllocationPayment{
                        ...
                        Currency: codatsyncpayables.String("USD"),
                        CurrencyRate: codatsyncpayables.Float64(4535.43),
                        ...
                        TotalAmount: codatsyncpayables.Float64(5966.56),
                    },
                },
            },
...
func main() {
    ...
    res, err := s.BillCreditNotes.Update(ctx, operations.UpdateBillCreditNoteRequest{
        BillCreditNote: &shared.BillCreditNote{
            ...
            BillCreditNoteNumber: codatsyncpayables.String("91fe2a83-e161-4c21-929d-c5c10c4b07e5"),
            Currency: codatsyncpayables.String("USD"),
            CurrencyRate: codatsyncpayables.Float64(6176.58),
            DiscountPercentage: 0,
            ID: codatsyncpayables.String("1509398f-98e2-436d-8a5d-c042e0c74ffc"),
            IssueDate: codatsyncpayables.String("2022-10-23T00:00:00.000Z"),
            LineItems: []shared.BillCreditNoteLineItem{
                shared.BillCreditNoteLineItem{
                    ...
                    DiscountAmount: codatsyncpayables.Float64(4254.51),
                    DiscountPercentage: codatsyncpayables.Float64(7980.47),
                    ItemRef: &shared.BillCreditNoteLineItemItemReference{
                        ID: "e2af7a73-cf3b-4e45-bf87-0b326b5a7342",
                        Name: codatsyncpayables.String("Simon Stracke MD"),
                    },
                    Quantity: 5173.79,
                    SubTotal: codatsyncpayables.Float64(2768.94),
                    TaxAmount: codatsyncpayables.Float64(1320.68),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: codatsyncpayables.Float64(1749.09),
                        ID: codatsyncpayables.String("bb679d23-2271-45bf-8cbb-1e31b8b90f34"),
                        Name: codatsyncpayables.String("Mr. Josephine Pagac V"),
                    },
                    TotalAmount: codatsyncpayables.Float64(9295.3),
                    Tracking: &shared.BillCreditNoteLineItemTracking{
                        CategoryRefs: []shared.TrackingCategoryRef{
                            shared.TrackingCategoryRef{
            ...
            PaymentAllocations: []shared.Items{
                shared.Items{
                    Allocation: shared.ItemsAllocation{
                        AllocatedOnDate: codatsyncpayables.String("2022-10-23T00:00:00.000Z"),
                        Currency: codatsyncpayables.String("GBP"),
                        CurrencyRate: codatsyncpayables.Float64(1783.67),
                        TotalAmount: codatsyncpayables.Float64(3738.13),
                    },
                    Payment: shared.PaymentAllocationPayment{
                        AccountRef: &shared.AccountRef{
                        ...
                        Currency: codatsyncpayables.String("USD"),
                        CurrencyRate: codatsyncpayables.Float64(2775.96),
                        ...
                        TotalAmount: codatsyncpayables.Float64(7313.98),
                    },
                },
            },
            RemainingCredit: codatsyncpayables.Float64(0),
