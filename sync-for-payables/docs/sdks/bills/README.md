...
func main() {
    ...
    res, err := s.Bills.List(ctx, operations.ListBillsRequest{
        ...
        Query: syncforpayables.String("architecto"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Bills.Update(ctx, operations.UpdateBillRequest{
        Bill: &shared.Bill{
            AmountDue: types.MustNewDecimalFromString("8671.68"),
            Currency: syncforpayables.String("EUR"),
            CurrencyRate: types.MustNewDecimalFromString("291.9"),
            DueDate: syncforpayables.String("2022-10-23T00:00:00.000Z"),
            ID: syncforpayables.String("8e6f8c5f-350d-48cd-b5a3-418143010421"),
            IssueDate: "2022-10-23T00:00:00.000Z",
            LineItems: []shared.BillLineItem{
                shared.BillLineItem{
                    AccountRef: &shared.AccountRef{
                        ID: syncforpayables.String("13d5208e-ce7e-4253-b668-451c6c6e205e"),
                        Name: syncforpayables.String("Sue Swaniawski"),
                    },
                    Description: syncforpayables.String("harum"),
                    DiscountAmount: types.MustNewDecimalFromString("1927.18"),
                    DiscountPercentage: types.MustNewDecimalFromString("9873.49"),
                    IsDirectCost: syncforpayables.Bool(false),
                    ItemRef: &shared.ItemRef{
                        ID: "ec9578a6-4584-4273-a841-8d162309fb09",
                        Name: syncforpayables.String("Kristina Moore MD"),
                    },
                    Quantity: types.MustNewDecimalFromString("8818.97"),
                    SubTotal: types.MustNewDecimalFromString("9768.02"),
                    TaxAmount: types.MustNewDecimalFromString("7196.2"),
                    TaxRateRef: &shared.TaxRateRef{
                        EffectiveTaxRate: types.MustNewDecimalFromString("6085.93"),
                        ID: syncforpayables.String("f58c4d86-e68e-44be-8560-13f59da757a5"),
                        Name: syncforpayables.String("Tomas Ryan"),
                    },
                    TotalAmount: types.MustNewDecimalFromString("9918.91"),
                    Tracking: &shared.Tracking{
                        CategoryRefs: []shared.TrackingCategoryRef{
                            shared.TrackingCategoryRef{
                                ID: "66ef1caa-3383-4c2b-ab47-7373c8d72f64",
                                Name: syncforpayables.String("Dennis Schumm DVM"),
                            },
                        },
                        CustomerRef: &shared.TrackingCustomerRef{
                            CompanyName: syncforpayables.String("quia"),
                        ...
                        ProjectRef: &shared.TrackingProjectReference{
                            ...
                            Name: syncforpayables.String("Patty Reinger"),
                        },
                    },
                    TrackingCategoryRefs: []shared.TrackingCategoryRef{
                        shared.TrackingCategoryRef{
                            ID: "72026114-35e1-439d-bc22-59b1abda8c07",
                            Name: syncforpayables.String("Ms. Tasha Block"),
                        },
                    },
