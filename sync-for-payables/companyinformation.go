...
// CompanyInformation - View company profile from the source platform.
...
func (s *CompanyInformation) Get(ctx context.Context, request operations.GetCompanyInformationRequest, opts ...operations.Option) (*operations.GetCompanyInformationResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/connections/{connectionId}/payables/info", request, nil)
	if err != nil {
