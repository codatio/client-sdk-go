...
// UpdateCompany401ApplicationJSON - Your API request was not properly authorized.
...
// UpdateCompanyCompanyConnectionSourceTypeEnum - The type of platform of the connection.
...
// UpdateCompanyCompanyConnectionDataConnectionStatusEnum - The current authorization status of the data connection.
...
// UpdateCompanyCompanyConnection - A connection represents the link between a `company` and a source of data.
...
// UpdateCompanyCompany - A company in Codat represent a small or medium sized business, whose data you wish to share
