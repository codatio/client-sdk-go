...
// UnlinkCompanyConnection404ApplicationJSON - One or more of the resources you referenced could not be found.
...
// UnlinkCompanyConnection401ApplicationJSON - Your API request was not properly authorized.
...
// UnlinkCompanyConnectionConnectionSourceTypeEnum - The type of platform of the connection.
...
// UnlinkCompanyConnectionConnectionDataConnectionStatusEnum - The current authorization status of the data connection.
...
// UnlinkCompanyConnectionConnection - A connection represents the link between a `company` and a source of data.
