...
// | Oracle NetSuite       | Yes       |
func (s *Reimbursements) Create(ctx context.Context, request operations.CreateReimbursableExpenseTransactionRequest, opts ...operations.Option) (*operations.CreateReimbursableExpenseTransactionResponse, error) {
...
// | QuickBooks Online     | Yes       |
// | Oracle NetSuite       | Yes       |
func (s *Reimbursements) Update(ctx context.Context, request operations.UpdateReimbursableExpenseTransactionRequest, opts ...operations.Option) (*operations.UpdateReimbursableExpenseTransactionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "UpdateReimbursableExpenseTransactionRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
