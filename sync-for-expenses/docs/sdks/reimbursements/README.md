...
func main() {
    ...
    res, err := s.Reimbursements.CreateReimbursableExpenseTransaction(ctx, operations.CreateReimbursableExpenseTransactionRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Reimbursements.UpdateReimbursableExpenseTransaction(ctx, operations.UpdateReimbursableExpenseTransactionRequest{
        CompanyID: "8a210b68-6988-11ed-a1eb-0242ac120002",
