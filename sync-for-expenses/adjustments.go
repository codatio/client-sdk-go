...
// Adjustments - Create transactions that represent your adjustments to your customers' spend.
type Adjustments struct {
	sdkConfiguration sdkConfiguration
}

func newAdjustments(sdkConfig sdkConfiguration) *Adjustments {
	return &Adjustments{
...
func (s *Adjustments) Create(ctx context.Context, request operations.CreateAdjustmentTransactionRequest, opts ...operations.Option) (*operations.CreateAdjustmentTransactionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/companies/{companyId}/sync/expenses/adjustment-transactions", request, nil)
	if err != nil {
	...
	res := &operations.CreateAdjustmentTransactionResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AdjustmentTransactionResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AdjustmentTransactionResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
