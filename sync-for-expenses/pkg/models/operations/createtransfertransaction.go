...
type CreateTransferTransactionRequest struct {
	TransferTransactionRequest *shared.TransferTransactionRequest `request:"mediaType=application/json"`
...
func (o *CreateTransferTransactionRequest) GetTransferTransactionRequest() *shared.TransferTransactionRequest {
	if o == nil {
		return nil
	}
	return o.TransferTransactionRequest
}
...
type CreateTransferTransactionResponse struct {
	...
	// OK
	TransferTransactionResponse *shared.TransferTransactionResponse
}
...
func (o *CreateTransferTransactionResponse) GetTransferTransactionResponse() *shared.TransferTransactionResponse {
	if o == nil {
		return nil
	}
	return o.TransferTransactionResponse
}
