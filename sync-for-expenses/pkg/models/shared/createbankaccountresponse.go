...
type CreateBankAccountResponseBankAccountType string

const (
	CreateBankAccountResponseBankAccountTypeUnknown CreateBankAccountResponseBankAccountType = "Unknown"
	CreateBankAccountResponseBankAccountTypeCredit  CreateBankAccountResponseBankAccountType = "Credit"
	CreateBankAccountResponseBankAccountTypeDebit   CreateBankAccountResponseBankAccountType = "Debit"
)

func (e CreateBankAccountResponseBankAccountType) ToPointer() *CreateBankAccountResponseBankAccountType {
	return &e
}
func (e *CreateBankAccountResponseBankAccountType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "Credit":
		fallthrough
	case "Debit":
		*e = CreateBankAccountResponseBankAccountType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateBankAccountResponseBankAccountType: %v", v)
	}
}
...
type AccountingBankAccount struct {
	...
	// For Credit accounts, positive balances are liabilities, and positive transactions **reduce** liabilities.
	// For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
	AccountType *CreateBankAccountResponseBankAccountType `json:"accountType,omitempty"`
...
func (o *AccountingBankAccount) GetAccountType() *CreateBankAccountResponseBankAccountType {
	if o == nil {
		return nil
	}
...
func (o *CreateBankAccountResponse) GetData() *AccountingBankAccount {
	if o == nil {
		return nil
	}
	return o.Data
