...
type CompanyInformationType string

const (
	CompanyInformationTypeWebsite CompanyInformationType = "Website"
	CompanyInformationTypeSocial  CompanyInformationType = "Social"
	CompanyInformationTypeUnknown CompanyInformationType = "Unknown"
)

func (e CompanyInformationType) ToPointer() *CompanyInformationType {
	return &e
}
func (e *CompanyInformationType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "Social":
		fallthrough
	case "Unknown":
		*e = CompanyInformationType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompanyInformationType: %v", v)
	}
}
...
type Weblink struct {
	...
	Type *CompanyInformationType `json:"type,omitempty"`
	// The full URL for the weblink.
	URL *string `json:"url,omitempty"`
}

func (o *Weblink) GetType() *CompanyInformationType {
	if o == nil {
		return nil
	}
	return o.Type
...
// CompanyInformation - Company info provides standard details about a linked company such as their address, phone number, and company registration.
//
...
func (o *CompanyInformation) GetAccountingPlatformRef() *string {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetAddresses() []AccountingAddress {
	if o == nil {
		return nil
	}
	return o.Addresses
...
func (o *CompanyInformation) GetCompanyLegalName() *string {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetCreatedDate() *string {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetFinancialYearStartDate() *string {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetLedgerLockDate() *string {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetPhoneNumbers() []Phone {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetRegistrationNumber() *string {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetSourceUrls() map[string]string {
	if o == nil {
		return nil
	}
	return o.SourceUrls
...
func (o *CompanyInformation) GetSupplementalData() *SupplementalData {
	if o == nil {
		return nil
	}
...
func (o *CompanyInformation) GetTaxNumber() *string {
	if o == nil {
		return nil
	}
	return o.TaxNumber
...
func (o *CompanyInformation) GetWebLinks() []Weblink {
	if o == nil {
		return nil
	}
	return o.WebLinks
