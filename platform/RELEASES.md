...
- [go v3.2.0] platform
### Releases
- [Go v3.2.0] https://github.com/codatio/client-sdk-go/releases/tag/platform/v3.2.0 - platform
...
- [go v5.0.0] platform
### Releases
- [Go v5.0.0] https://github.com/codatio/client-sdk-go/releases/tag/platform/v5.0.0 - platform