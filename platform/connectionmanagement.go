...
// ConnectionManagementCorsSettingsGet - Get CORS settings
...
func (s *ConnectionManagement) ConnectionManagementCorsSettingsGet(ctx context.Context, opts ...operations.Option) (*operations.GetConnectionManagementCorsSettingsResponse, error) {
...
// ConnectionManagementCorsSettingsSet - Set CORS settings
...
//
// The embedded [connection management UI](https://docs.codat.io/auth-flow/optimize/connection-management) lets your customers control access to their data by allowing them to manage their existing connections.
func (s *ConnectionManagement) ConnectionManagementCorsSettingsSet(ctx context.Context, request *shared.ConnectionManagementAllowedOrigins, opts ...operations.Option) (*operations.SetConnectionManagementCorsSettingsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
//
// The embedded [connection management UI](https://docs.codat.io/auth-flow/optimize/connection-management) lets your customers control access to their data by allowing them to manage their existing connections.
func (s *ConnectionManagement) Get(ctx context.Context, request operations.GetConnectionManagementAccessTokenRequest, opts ...operations.Option) (*operations.GetConnectionManagementAccessTokenResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
